...
POSTS = [
    ...
    ("ayan", "EUR/USD", 1.9, 1,
     ...
     "একটা প্যাটার্ন। অপেক্ষাটা বিরক্তিকর, কিন্তু ওটাই কাজের।", True, 88, 16),
    ...
    ("nusrat", "EUR/USD", 1.6, 22,
     ...
     "রাখি না — এটা নিয়ম, লাভ কমলেও।", True, 71, 8),
    ("rifat", "USD/JPY", 2.0, 28,
     ...
     "বদলালে আজ আমি অন্য কিছু করতাম আর এটা মিস করতাম।", True, 187, 51),
    ...
    ("ayan", "USD/JPY", 2.3, 104,
     ...
     "একটা সেটআপ ভালো করে শেখা দশটা মাঝারি জানার চেয়ে ভালো।", True, 119, 23),
