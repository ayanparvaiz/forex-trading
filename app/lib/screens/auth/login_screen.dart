...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        // A form scrolls as one piece. A ListView would build these lazily and
        // dispose whatever the keyboard pushes out of view — including the
        // field being typed into, which takes the text input connection with
        // it and starts swallowing characters.
